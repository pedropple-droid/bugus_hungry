...
//Check inside collisin
	with (obj_bugu)
	{
	    if (place_meeting(x, y, other)) 
		{
			...
			if obj_gamemanager.PPWin
			{
				global.player_score += 35 * global.score_multiplier
			}
			else global.player_score += 35;
			
			if obj_gamemanager.PPReset
			{
...
//Check inside collisin
	var _objs = [obj_rock_obst, obj_explodingrock, obj_geyser, obj_banana];
