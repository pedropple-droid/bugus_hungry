function sound_handlerFX(sound, loops = false, bitcrush = true, reverb = true, priority = 1, gain = (global.gain * global.FXvolume), pitch = random_range(0.75, 1.25), await = false)
{
